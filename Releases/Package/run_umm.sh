#!/bin/sh
# Unity Mod Manager start script
#
# Run the script to start the game with UMM enabled
#
# There are two ways to use this script
#
# 1. Via CLI: Run ./start_game_umm.sh <path to game> [doorstop arguments] [game arguments]
# 2. Via config: edit the options below and run ./start_game_umm.sh without any arguments
...
target_assembly="UMM/Core/UnityModManager.dll"
